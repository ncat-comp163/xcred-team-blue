...
public class tictac extends JFrame implements ActionListener {
  ...
  /**
   * This is the contructor method that makes the pane for the tic tac toe board
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    //123|
    if(button1.getIcon() == button2.getIcon() && button2.getIcon() == button3.getIcon() && button1.getIcon() != null) {
      if (clicks % 2 == 1) {
    ...
    //456 |
    if(button4.getIcon() == button5.getIcon() && button5.getIcon() == button6.getIcon() && button4.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //789  |
    if(button7.getIcon() == button8.getIcon() && button8.getIcon() == button9.getIcon() && button7.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //147
    if(button1.getIcon() == button4.getIcon() && button4.getIcon() == button7.getIcon() && button1.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //258
    if(button2.getIcon() == button5.getIcon() && button5.getIcon() == button8.getIcon() && button2.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //369
    if(button3.getIcon() == button6.getIcon() && button6.getIcon() == button9.getIcon() && button3.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //159
    if(button1.getIcon() == button5.getIcon() && button5.getIcon() == button9.getIcon() && button1.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
    ...
    //357/
    if(button3.getIcon() == button5.getIcon() && button5.getIcon() == button7.getIcon() && button3.getIcon() != null) {
      if (clicks % 2 == 1) {
        setTitle("Player 1 WINS!!!");
        Winner = 1;
      } else {
